jQuery(document).ready(function($) {
	...
	$.fn.bindUploadReplaceImage = function(){
        ...
        grveMediaImageReplaceFrame.on('select', function(){
			...
			$.post( movedo_grve_upload_image_replace_texts.ajaxurl, { action:'movedo_grve_get_replaced_image', attachment_id: ids.toString(), attachment_mode: grveMediaImageReplaceMode, field_name: grveMediaImageFieldName } , function( mediaHtml ) {
