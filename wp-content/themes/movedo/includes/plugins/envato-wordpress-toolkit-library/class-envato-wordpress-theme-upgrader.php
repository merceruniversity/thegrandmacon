...
if ( !class_exists( 'Envato_Protected_API' ) ) {
	include_once get_template_directory() . '/includes/plugins/envato-wordpress-toolkit-library/class-envato-protected-api.php';
}
...
if ( class_exists( 'Theme_Upgrader' ) && ! class_exists( 'Envato_WordPress_Theme_Upgrader' ) ) {
    ...
    class Envato_WordPress_Theme_Upgrader extends Theme_Upgrader 
    {
        ...
        public function upgrade_strings() {
            ...
            $this->strings['downloading_package'] = esc_html__( 'Downloading upgrade package from the Envato API&#8230;', 'movedo' );
        }
        ...
        public function install_strings() {
            ...
            $this->strings['downloading_package'] = esc_html__( 'Downloading install package from the Envato API&#8230;', 'movedo' );
        }
