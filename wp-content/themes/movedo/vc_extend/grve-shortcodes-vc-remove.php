...
if ( function_exists( 'vc_remove_element' ) ) {
	...
	add_action( 'init', 'movedo_grve_remove_vc_shortcodes' );

	if ( !function_exists( 'movedo_grve_remove_vc_shortcodes' ) && function_exists( 'vc_remove_element' ) ) {

		function movedo_grve_remove_vc_shortcodes() {

			if ( !movedo_grve_vc_social_elements_visibility() ) {
				//Social
			...
			if ( !movedo_grve_vc_wp_elements_visibility() ) {
				//WordPress
			...
			if ( !movedo_grve_vc_charts_visibility() ) {
				//Charts
				vc_remove_element('vc_round_chart');
				vc_remove_element('vc_line_chart');
			}

			if ( !movedo_grve_vc_woo_visibility() ) {
				//WooCommerce
			...
			if ( !movedo_grve_vc_other_elements_visibility() ) {
				//Other
...
if ( is_admin() ) {
	if ( ! function_exists('movedo_grve_remove_vc_boxes') ) {
		function movedo_grve_remove_vc_boxes(){
	...
	add_action('do_meta_boxes', 'movedo_grve_remove_vc_boxes');
}
